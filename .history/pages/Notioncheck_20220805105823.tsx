...
export default function Notioncheck() {
  return (
    <div className=' bg-[#f7f2f2]  dark:text-white font-cadizMedium md:font-ApercuMedium min-h-screen'>
            ...
            <div>
              <div className='space-y-3'>
                <h1 className='text-xl items-start relative flex flex-col'>
                  ...
                  <Image src="/Assets/underline.svg" width={110} height={10} alt="" className='absolute bottom-0' />
                </h1>
                <p className='text-sm'>Simplify your workflows with my Functional, comprehensive, and beginner-friendly notion checklists.</p>
              </div>
              <div>
                <Image src="/Assets/notion-logo-1.svg" width={72} height={72} alt="" className='' />
