    ...
    return (
        <div className="flex min-h-screen items-center justify-center  flex-col dark:text-white bg-[#f7f2f2] dark:bg-[#090c10]  font-cadizMedium  md:px-8 md:pb-8">
            <div className=''>
                ...
                <div className='flex items-center justify-center p-2 space-x-2 bg-white dark:bg-[#0d1117] border-2 border-gray-300 dark:border-[#24292f] rounded-lg  hover:opacity-80 animate-wobble'>
