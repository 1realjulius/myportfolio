          ...
          <div className='flex'>
            <div>
              ...
              <div className='flex flex-row items-center'>
                <div className='mx-2'><Image src="/Assets/notion-logo-1.svg" width={30} height={30} alt="" className='' /></div>
                <div className='mx-2'><Image src="/Assets/gumroad-logo.png" width={74} height={42} alt="" className='mx-2' /></div>
              </div>
