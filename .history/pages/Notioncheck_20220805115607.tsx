  ...
  return (
    <div className=" bg-[#f7f2f2]  font-cadizMedium md:font-ApercuMedium min-h-screen">
      <div className="px-8 md:px-6 py-4">
        ...
        <div></div>
        {/* Screenshots */}
        <section class="grid grid-cols-1 gap-y-10 gap-x-6 pt-10 lg:grid-cols-3"><h2 class="text-2xl font-semibold leading-9 tracking-tight text-slate-900">Screenshots</h2><div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2"><img src="https://tailwindui.com/img/templates/transmit/detail-01.png" alt="This is a detail image" class="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"><img src="https://tailwindui.com/img/templates/transmit/detail-02.png" alt="This is a detail image" class="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"><img src="https://tailwindui.com/img/templates/transmit/detail-03.png" alt="This is a detail image" class="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"><img src="https://tailwindui.com/img/templates/transmit/detail-04.png" alt="This is a detail image" class="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"></div></section>
