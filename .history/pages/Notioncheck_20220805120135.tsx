      ...
      <div className="px-8 md:px-6 py-4">
        ...
        <section className="grid grid-cols-1 gap-y-10 gap-x-6 pt-10 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2">
            <Image src="https://tailwindui.com/img/templates/transmit/detail-01.png" alt="This is a detail image" width='42' height='402' className="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"/>
            <Image src="https://tailwindui.com/img/templates/transmit/detail-02.png" alt="This is a detail image" width='42' height='402' className="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"/>
            <Image src="https://tailwindui.com/img/templates/transmit/detail-03.png" alt="This is a detail image" width='42' height='402' className="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"/>
            <Image src="https://tailwindui.com/img/templates/transmit/detail-04.png" alt="This is a detail image" width='42' height='402' className="aspect-[384/246] rounded-lg bg-slate-200 ring-1 ring-slate-900/10"/>
            </div>
        </section>
