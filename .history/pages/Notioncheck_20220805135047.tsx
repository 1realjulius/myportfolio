      ...
      <div className="px-8 md:px-6 pb-4">
        ...
        <section className="grid grid-cols-1 items-baseline gap-y-10 gap-x-6 lg:grid-cols-3">
          ...
          <div className="max-w-2xl space-y-10 lg:col-span-2 prose prose-slate prose-a: prose-a:text-sky-500 hover:prose-a:text-sky-600">
            ...
            <p>
              <strong>Freelance Web Dev Pack</strong> — All The Essential Freelance Tools for Managing your Web development Career.
            </p>
            <p>
            ...
            <p>
              <strong>Business Invoice</strong> — A Functional and Comprehensive Web Development Pack with All the Essentials for Freelancers.
            </p>
            <p>
              <strong>Client Service Agreement</strong> — Create a legal relationsship between you and your client.
            </p>
          </div>
        </section>
        {/* Screenshots */}
