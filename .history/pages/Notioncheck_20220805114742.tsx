              ...
              <div className="mx-auto grid max-w-[40rem] grid-cols-1 gap-y-16 gap-x-8 lg:max-w-none lg:grid-cols-3">
                <div className="flex flex-col lg:pb-6">
                  ...
                  <div className='mt-5 flex flex-row items-center'>
                    <div className='mx-1'><Image src="/Assets/notion-logo-1.svg" width={60} height={60} alt="" className='' /></div>
                    <div className='mx-1'><Image src="/Assets/gumroad-logo.png" width={144} height={82} alt="" className='mx-2' /></div>
                  </div>
