    ...
    <div className='p-4 font-cadizMedium'>
        <div>
            <div className='px-2 pb-1'>
                ...
                <p className='text-base font-cadizMedium dark:text-white'>Add me to your team.</p>
            </div>
            ...
            <div className='px-2 pt-1'>
                <p className='text-xs text-gray-400'>I am generally opened to and Job concering Front-End Web Development</p>
            </div>
        </div>
    </div>
  )
