  ...
  return (
    <div>
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
        ...
        {/* project 1 section */}
        <div className="row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg  cursor-not-allowed">
          <div>
          <Image
              src="/Assets/Project-Test.png"
              width='400'
              height={200}
              alt="Julius Eghan Memoji"
