    ...
    <div>
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
        ...
        <div className="flex">
          ...
          <div className="flex flex-col  md:grid md:grid-cols-4 mx-4 border-2 dark:border-[#24292f] md:divide-x-2 divide-y-2 md:divide-y-0 dark:divide-[#24292f] rounded-md ">
