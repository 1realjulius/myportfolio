...
import { ChevronRight, ExternalLink, Phone, X,} from 'react-feather'
        ...
        <div id='Projects' className='row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg p-4'>
          <div className='flex space-x-2'>
            <div className='flex  items-center'>
              <div className='flex flex-row bg-white items-center py-1 px-2 rounded space-x-2'>
                ...
                <h1 className='text-[12px] text-black'>Notion Official Template</h1>
              </div>
            </div>
            <div className='flex  items-center'>
              <div className='flex flex-row bg-gray-100 items-center py-1 px-2 rounded space-x-2'>
                <Image src="/Assets/notion-logo-1.svg" width="12" height='12' alt="" className='' />
                <h1 className='text-[12px] text-black'>Free and Premium Notion Template</h1>
              </div>
            </div>
          </div>
          <div className="my-2 mt-6 flex  space-x-2">
            ...
            <div className='flex-1 items-center justify-center'>
              <h1 className='text-base'>Notioncheck</h1>
              <p className='text-xs '>Simplify your workflows with my Functional, comprehensive and beginner friendly notion checklists.</p>
            </div>
          </div>
          <div className='flex space-x-2 items-center divide-x'>
            <div className='flex  items-center'>
              <div className='flex flex-row bg-white items-center py-1 px-2 rounded space-x-2'>
                <Image src="/Assets/Notioncheck-logo-01.svg" width="14" height='14' alt="" className='' />
                <h1 className='text-[14px] text-black'>Notioncheck Notion Checklists</h1>
              </div>
            </div>
            <Link href="/Notioncheck">
               <div className='flex py-1 px-3 items-center  cursor-pointer'>
                    <p className='text-gray-400 text-sm'>View Project </p>
                   <div className=''>
