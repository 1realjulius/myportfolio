            ...
            <div className="flex space-x-5 pt-2">
              ...
              <Link href="#PricesAndPackages">
                <p className="text-sm flex space-x-2 items-center">
                  <span className="text-gray-500 dark:text-blue-600"> Check Out My Prices and Packages</span>
                  <Package
                    className="flex text-gray-500 dark:text-blue-600 animate-headShake"
                    size={16}
                  />
                </p>
              </Link>
