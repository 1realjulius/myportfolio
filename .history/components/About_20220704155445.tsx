  ...
  return (
    <div>
      <div className=' text-black dark:text-white flex flex-col px-4  md:flex-row  md:px-4 items-center justify-center'>
        ...
        {/* this is the links */}
        <div className='flex bg-white dark:bg-[#0d1117] md:mx-2  my-1 md:grid md:grid-cols-2 md:gap-4 gap-10 p-2  items-center justify-center rounded-lg border-2 dark:border-[#24292f]'>
