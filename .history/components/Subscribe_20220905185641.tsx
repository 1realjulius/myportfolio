  ...
  return (
    <div className="">
      <form className="flex flex-col mx-2">
        <div className="col-span-3 sm:col-span-3">
            <div className="mt-3 flex rounded-md shadow-sm">
              <input
                ...
                id="new-client-email"
                className="font-ApercuMedium focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md text-lg  border-gray-300  bg-white dark:text-white dark:bg-[#0d1117]"
        ...
        {state === 'Error' && (
          <p className="error-state text-base p-1 bg-red-300 rounded-full text-red-600 flex justify-center text-center ">{errorMsg}</p>
        )}
        {state === 'Success' && (
