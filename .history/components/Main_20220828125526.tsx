        ...
        <div className=" flex p-2 row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f]  flex-col border-2 rounded-lg">
          ...
          <div className="p-2">
            ...
            <div className="text-sm mt-1">
              <p>A Professional Photography Agency For Your Special Services.</p>
            </div>
          </div>
        </div>
        {/* Webncos section */}
        <div className=" flex p-2 row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f]  flex-col border-2 rounded-lg">
          <div>
            ...
            <Image
              ...
              className="rounded-t-md"
            />
            <Image alt="Vercel" srcset="/images/logos/color/vercel.svg 1x, /images/logos/color/vercel.svg 2x" src="/images/logos/color/vercel.svg" width="150" height="75" decoding="async" data-nimg="future" class="mx-8 dark:hidden inline" style="color:transparent;width:150px;height:75px"/>
          </div>
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
