          ...
          <div className=" flex flex-col border-2 dark:border-[#24292f] divide-y-2 dark:divide-[#24292f] rounded-md">
            <div className="p-2">
              ...
              <div className="flex flex-col">
                ...
                <h2 className="text-sm font-cadizMedium">
                  My journey as an entrepreneur started with a simple idea, and a lot of inspirations
                  to bring me to that final destination 🏝️. I am going to be sharing my journey with you as well
