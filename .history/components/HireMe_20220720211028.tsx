    ...
    <div className='p-4 pt-8 font-cadizMedium'>
        <div>
            <div className='px-2 pb-2'>
                ...
                <p className='text-sm font-cadizMedium text-gray-400'>I am familiar with systems like Git, Expo, Web 3 development, Webflow and Figma. I am dedicated to driving <span className='text-white'> innovation</span> with the ability to follow industry and technological trends and facilitating the early adoption of innovations.</p>
            </div>
