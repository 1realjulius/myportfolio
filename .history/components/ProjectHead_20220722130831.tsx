...
export const ProjectHead = () => {
  return (
    <div className='mx-4 flex flex-col md:flex-row items-center space-x-2'>
        <div className='border-2 rounded-lg'>
          <Image src="/Assets/notioncheck-dark.png" width="400%" height='400%' alt="" className='rounded-lg' />
        </div>
        <div className=''>
