        ...
        <div className='flex-1'>
            ...
            <div className='border-2 divide-y-2 rounded-lg'>
                <div className='flex items-center justify-between py-1 px-2'>
                    <p className='tex-base mr-4'>Project Name</p>
                    <p className='tex-base mr-4'>Notioncheck</p>
                </div>
                <div className='flex items-center justify-between py-1 px-2'>
                    <p className='tex-base mr-4'>Project Type</p>
                    <p className='tex-base mr-4'>Templates Store</p>
                </div>
                <div className='flex items-center justify-between py-1 px-2'>
                    <p className='tex-base mr-4'>Project Link</p>
                    <p className='tex-base mr-4'>Notioncheck</p>
                </div>
            </div>
        </div>
