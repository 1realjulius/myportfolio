    ...
    <div>
      <div className="flex flex-col gap-2 px-4 py-2 text-black dark:text-white md:grid md:grid-cols-3 md:gap-4 md:px-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-5 pt-2">
              <div className="flex cursor-default items-center space-x-2 text-sm text-gray-500">
                <p className="text-base">This Website looks great in Dark Mode</p>
                <span>
                  <svg
                    className="h-4 w-4"
                    fill="currentColor"
          ...
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
              ...
              <Link href="https://www.webncos.com/">
                <div className="flex cursor-pointer flex-row items-center space-x-2 rounded-md bg-blue-200 px-3 py-1 text-sm dark:bg-gray-900">
                  <p>View Website</p>
                  <span>
                    <svg
                      className="h-4 w-4 hover:animate-wobble"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div className=" row-span-2 flex cursor-not-allowed flex-col rounded-lg border-2 bg-white p-2  opacity-50 dark:border-[#24292f] dark:bg-[#0d1117]  dark:text-white">
          ...
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
              ...
              <div className="flex flex-row items-center space-x-2 rounded-md bg-blue-200 px-3 py-1 text-sm dark:bg-gray-900">
                <p>View Website</p>
                <span>
                  <svg
                    className="h-4 w-4"
        ...
        <div className=" col-span-2 row-span-2 flex flex-col rounded-lg border-2 bg-white text-sm dark:border-[#24292f] dark:bg-[#0d1117] dark:text-white">
          <div className="flex">
            <h1 className="relative my-3 ml-6 mt-2">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-0 h-[0.48em] w-full fill-blue-300/40"
        ...
        <div className="row-span-3 flex flex-col gap-2 rounded-lg border-2 bg-white p-4 dark:border-[#24292f] dark:bg-[#0d1117]">
          ...
          <div className="divide-y-2 rounded-lg  border-2 dark:divide-[#24292f] dark:border-[#24292f]">
            <div className="flex flex-col items-start p-2 pt-2 ">
              ...
              <h2 className="font-cadizMedium text-sm">
        ...
        >
          <div className="">
            ...
            <h2 className="px-2 font-cadizMedium text-sm">
            ...
            <div className="flex items-center justify-center">
              <span className="justify-center px-2 text-center text-[10px] text-gray-400">
