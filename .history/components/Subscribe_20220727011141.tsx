      ...
      <form className="flex flex-col mx-2">
        ...
        <div className="mt-4">
          <button
            ...
            onClick={subscribe}
            name="subscribe"
            className="items-center space-x-2 inline-flex justify-center active:bg-red-500 rounded-md border border-transparent bg-red-100 px-4 py-2 text-sm font-medium text-blue-900 hover:bg-red-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 w-full"
