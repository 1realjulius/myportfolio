              ...
              >
                ...
                <div className='relative flex text-right items-center justify-end'>
                  ...
                  >
                    ...
                    <p className=' font-cadizMedium text-sm text-gray-400'>I am gathering internet tips and tricks for anyone who likes to be on the internet as part of my meaningful change in the world 🌍 Journey.</p>
