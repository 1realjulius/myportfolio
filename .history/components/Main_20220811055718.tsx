            ...
            <div className="p-2">
              <div className="flex">
                <h1 className="relative">
                  ...
                  <span>My Journey as Entrepreneur</span>
                </h1>
              </div>
              <div>
                <h2 className="text-sm font-cadizMedium">
                  Would be entrepreneurs live in  a sea of dreams. Their destinations are private islands 🏝️, places to build,
                  create and transform their particular dreams into reality. Being an entrepreneur entails envisioning your island,
                  and even more important, it means getting in the boat and rowing to your island🏝️. All dreamers may one day be entrepreneurs
                  if they marshal the resources both externaly and internaly needed to transform their dreams into reality.
                </h2>
              </div>
            </div>
            <div>
              <div className="bg-gray-600 rounded-md m-2 px-4 py-2 ">
                <p>buttons</p>
              </div>
            </div>
          </div>
