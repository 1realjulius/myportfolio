  ...
  return (
    <div>
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
        ...
        {/* about me */}
        <div className=" dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg py-6 items-center justify-center " >
          <div className=" flex border-2 dark:border-[#24292f] divide-y-2 dark:divide-[#24292f] rounded-md">
            <div>The main content</div>
            <div>Bottom to page</div>
          </div>
        </div>
        {/* contact me */}
        <div
