  ...
  return (
    <div>
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
        ...
        <div className="flex">
            <h1 className="relative ml-6 my-1">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-0 h-[0.48em] w-full fill-blue-300/40"
          ...
          <div className="flex flex-col  md:grid md:grid-cols-4 mx-4 my-2 border-2 dark:border-[#24292f] md:divide-x-2 divide-y-2 md:divide-y-0 dark:divide-[#24292f] rounded-md ">
