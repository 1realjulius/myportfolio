...
function Navbar() {
  return (
    <div className='flex flex-col sm:flex-row items-center justify-between pb-2 md:px-4'>
        <div className='py-1 pt-0 text-lg px-3 cursor-pointer font-ApercuBlack bg-gradient-to-r text-transparent bg-clip-text from-blue-800 to-purple-400 animate-jello'>iamjulius</div>
