  ...
  return (
    <div>
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
        ...
        {/* Notioncheck Project section */}
        <div
          id="Projects"
          className="hidden row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f]  flex-col border-2 rounded-lg p-4"
        >
          ...
          <div className="flex space-x-2 items-center justify-center bg-gray-400/80  dark:border-2 dark:border-[#24292f] py-1 rounded-lg hover:opacity-40 cursor-pointer animate-pulse">
            <Link href="/Notioncheck">
              <div className="flex py-1 px-3 items-center  cursor-pointer space-x-2 ">
