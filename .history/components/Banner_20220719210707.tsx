...
const Banner = () => {
  return (
    <div className=' sticky top-0 flex flex-col items-center justify-center md:rounded-lg dark:bg-[#0d1117] bg-white mb-4 md:mt-2 p-2 md:border-2 dark:border-[#24292f]'>
