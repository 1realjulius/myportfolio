        ...
        >
          <div className="">
            ...
            <div className="flex flex-row items-center justify-center py-2">
              <div className="relative flex h-[210px] w-[210px] items-center  rounded-full border-4 border-gray-300 dark:border-[#24292f]">
                <Image
                ...
                />
                <div className="relative flex h-[40px] w-[80px] items-center justify-center">
                  <Image
                    src="/Assets/Julius_Eghan.jpg"
                    // width={200}
                    // height={200}
