    ...
    <div>
      <div className='text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2'>
        ...
        <div id='Projects' className='row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg p-4'>
          ...
          <div className="my-2 md:mt-4 flex md:flex-col space-x-2">
            ...
            <div className='flex-2 items-center justify-center'>
              <h1 className='text-base text-center'>Notioncheck</h1>
              <p className='text-sm text-center'>Simplify your workflows with my Functional, comprehensive and beginner friendly notion checklists.</p>
            </div>
          </div>
          <Link href="#">
             <div className='flex border-2 border-blue-400 py-1 px-2 rounded justify-between items-center cursor-pointer'>
                 <p className='text-base text-blue-800'>View Projects...</p>
