              ...
              >
                ...
                <div className='relative flex text-right items-center justify-end'>
                  ...
                  >
                    ...
                    <p className=' font-cadizMedium text-sm text-gray-400'>I am gatthering internet tips and tricks for anyone who like to be on the internet as part of my meaningfull change in the world 🌍 Journey.</p>
