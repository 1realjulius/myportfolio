      ...
      <div className="flex flex-col gap-2 px-4 py-2 text-black dark:text-white md:grid md:grid-cols-3 md:gap-4 md:px-4">
        ...
        <div className="col-span-3 row-span-2 my-1 rounded-lg border-2 bg-white p-4 dark:border-[#24292f] dark:bg-[#0d1117]">
            ...
            <div className="flex flex-row items-center space-x-6">
              ...
              <div>
                <Link href="https://www.linkedin.com/in/julius-baffour-eghan-4bb7a820a/">
                  <button className="">
                    <Linkedin
                      className="text-black hover:text-[#0072b1] dark:text-white"
                      size={25}
                    />
                  </button>
                </Link>
          ...
          <div className="flex flex-col">
            ...
            <p className="text-lg">
              I’m
              <span className="relative mx-2 whitespace-nowrap text-blue-600">
                <svg
                  aria-hidden="true"
                  viewBox="0 0 418 42"
            ...
            <div className="flex space-x-5 pt-2">
              <div className="flex cursor-default items-center space-x-2 text-sm text-gray-500">
                <p className="text-base">
                  This Website looks great in Dark Mode
                </p>
                <span>
                  <svg
                    className="h-4 w-4"
          ...
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
              <div className="flex flex-row items-center space-x-2 ">
                <div className="flex rounded-sm bg-[#0d1117] p-1 dark:flex-none dark:rounded-none dark:bg-inherit dark:p-0">
                  <Image
                ...
                <h1 className="text-xl">Photocos Agency</h1>
              </div>
              <Link href="https://1realjulius.github.io/Photocos_Agency/">
                <div className="group flex cursor-pointer flex-row items-center rounded-full bg-blue-200 p-3 dark:bg-gray-900">
                  <span>
                    <svg
                      className="h-6 w-6 group-hover:animate-wobble"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mt-1 text-lg">
              <p>
                A Professional Photography Agency For Your Special Services.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className=" row-span-2 flex flex-col rounded-lg border-2 bg-white p-2  dark:border-[#24292f] dark:bg-[#0d1117] dark:text-white">
          ...
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
              <div className="flex flex-row items-center rounded-sm bg-white p-[2px]">
                <Image
        ...
        <div className=" row-span-2 flex cursor-not-allowed flex-col rounded-lg border-2 bg-white p-2  opacity-50 dark:border-[#24292f] dark:bg-[#0d1117]  dark:text-white">
          ...
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
              <h1 className="text-xl">Project Coming Soon</h1>
              <div className="group flex cursor-pointer flex-row items-center rounded-full bg-blue-200 p-3 dark:bg-gray-900">
                <span>
                  <svg
                    className="h-6 w-6 group-hover:animate-wobble"
        ...
        {/* What I do best */}
        <div className=" col-span-2 row-span-2 flex flex-col rounded-lg border-2 bg-white text-sm dark:border-[#24292f] dark:bg-[#0d1117] dark:text-white">
          <div className="flex">
            <h1 className="relative my-3 ml-6 mt-2 text-xl">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-0 h-[0.48em] w-full fill-blue-300/40"
          ...
          <div className="mx-4 mb-4  flex flex-col divide-y-2 rounded-md border-2 dark:divide-[#24292f] dark:border-[#24292f] md:grid md:grid-cols-4 md:divide-x-2 md:divide-y-0 ">
            <div className="flex items-center py-2 px-4 md:flex-col">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-6 w-6 text-blue-300 md:mb-3"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
            ...
            <div className="flex items-center py-2 px-4 md:flex-col">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-6 w-6 text-yellow-300 md:mb-3"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
            ...
            <div className="flex items-center py-2 px-4 md:flex-col">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-6 w-6 text-green-300 md:mb-3"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
              ...
              <h2 className="text-lg md:text-center">
                Providing Satisfactory Customer Services
              </h2>
            </div>
            <div className="flex items-center py-2 px-4 md:flex-col">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-6 w-6 text-gray-400 md:mb-3"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
              ...
              <h2 className="text-lg md:text-center">
                Maximizing Client&apos;s operations effectively
              </h2>
            </div>
          </div>
        </div>
        {/* what i do section */}
        <div className="row-span-3 flex flex-col gap-2 rounded-lg border-2 bg-white p-4 dark:border-[#24292f] dark:bg-[#0d1117]">
          <div className="flex">
          ...
          <div className="divide-y-2 rounded-lg  border-2 dark:divide-[#24292f] dark:border-[#24292f]">
            <div className="flex flex-col items-start p-2 pt-2 ">
            ...
            <div className="flex flex-col items-start p-2  pt-2 ">
              <div className="flex items-center text-sm font-medium text-slate-500">
                <svg
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-8 w-8 flex-none animate-spin stroke-blue-400"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                >
                ...
                <span className="ml-2.5 font-cadizMedium text-lg">
                  React Native
                </span>
              </div>
              <h2 className="font-cadizMedium text-lg">
          ...
          <div className="mb-1 ml-2 flex">
            <h1 className=" mb-1 text-xl">
              ...
              <span className="relative">
                ...
                <span>Entrepreneur 🏝️</span>
              </span>
            </h1>
          </div>
          <div className=" flex flex-col divide-y-2 rounded-md border-2 dark:divide-[#24292f] dark:border-[#24292f]">
            <div className="p-2">
              <div className="flex flex-col">
                <h2 className="font-cadizMedium text-lg">
                  Would be entrepreneurs live in a sea of dreams ⛵. Their
                  destinations are private islands, places to build, create and
                  transform their particular dreams into reality. Being an
                ...
                <h2 className="font-cadizMedium text-lg">
                  {" "}
                  I am going to be sharing my journey with you as well as my
                  inspirations and motivations.
                </h2>
              </div>
            </div>
            <div>
              <div className="m-2 flex animate-pulse cursor-pointer items-center justify-center rounded-md bg-gray-400/80 px-4 py-2">
                <h1 className="relative">
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 418 42"
                    className="absolute top-2/3 left-0 h-[0.58em] w-full fill-gray-300/40"
                    preserveAspectRatio="none"
                  >
                    <path d="M203.371.916c-26.013-2.078-76.686 1.963-124.73 9.946L67.3 12.749C35.421 18.062 18.2 21.766 6.004 25.934 1.244 27.561.828 27.778.874 28.61c.07 1.214.828 1.121 9.595-1.176 9.072-2.377 17.15-3.92 39.246-7.496C123.565 7.986 157.869 4.492 195.942 5.046c7.461.108 19.25 1.696 19.17 2.582-.107 1.183-7.874 4.31-25.75 10.366-21.992 7.45-35.43 12.534-36.701 13.884-2.173 2.308-.202 4.407 4.442 4.734 2.654.187 3.263.157 15.593-.78 35.401-2.686 57.944-3.488 88.365-3.143 46.327.526 75.721 2.23 130.788 7.584 19.787 1.924 20.814 1.98 24.557 1.332l.066-.011c1.201-.203 1.53-1.825.399-2.335-2.911-1.31-4.893-1.604-22.048-3.261-57.509-5.556-87.871-7.36-132.059-7.842-23.239-.254-33.617-.116-50.627.674-11.629.54-42.371 2.494-46.696 2.967-2.359.259 8.133-3.625 26.504-9.81 23.239-7.825 27.934-10.149 28.304-14.005.417-4.348-3.529-6-16.878-7.066Z"></path>
                  </svg>
                  <span>Journey coming soon 🏝️</span>
                </h1>
              </div>
            </div>
          </div>
        ...
        <div
          id="Contact"
          className=" flex flex-col justify-center rounded-lg border-2 bg-white p-2 dark:border-[#24292f] dark:bg-[#0d1117] dark:text-white"
        >
          <div className="">
            <div className="flex">
              <h1 className="relative ml-2 text-xl">
                <svg
                  aria-hidden="true"
                  viewBox="0 0 418 42"
                  className="absolute top-2/3 left-0 h-[0.48em] w-full fill-blue-300/40"
            ...
            <div className=" flex flex-col divide-y-2 rounded-lg border-2 dark:divide-[#24292f] dark:border-[#24292f]">
              ...
              <Link href="tel:+233549321512">
                <span className="flex flex-row items-center cursor-pointer py-1 px-2 text-lg text-blue-400 hover:underline justify-center">
                  +233 549 321 512
                </span>
              </Link>
              <h1 className="flex items-center space-x-2 py-1 px-2 text-base text-gray-400 justify-center">
            ...
            <div className="divide-y-2 rounded-lg  border-2 dark:divide-[#24292f] dark:border-[#24292f]">
                ...
                <div className="  m-1 rounded-md bg-[#ffdd00] ">
                  <Link href="https://www.buymeacoffee.com/iamjulius">
                    ...
                    >
                      ...
                      <span>
                        <svg
                          className="h-6 w-6 hover:animate-wiggle"
                          width="884"
                          height="1279"
              ...
              {/* My Gumroad Store */}
              <div>
                <div className="  m-1 rounded-md bg-[#FF90E8] ">
                  <Link href="https://notioncheck.gumroad.com/">
                    ...
                    >
                      ...
                      <h1 className="flex flex-row items-center space-x-2">
                        <span className="font-ApercuBold text-base text-black">
                          Notioncheck
                        </span>
                        <svg
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M18.401 14.716L126.316 7.09236C139.568 6.00206 142.978 6.73247 151.306 12.5365L185.754 35.7626C191.438 39.7565 193.333 40.8438 193.333 45.1977V172.583C193.333 180.566 190.301 185.288 179.702 186.01L54.3803 193.269C46.4236 193.633 42.6367 192.546 38.4699 187.462L13.1021 155.888C8.55696 150.076 6.66664 145.728 6.66664 140.642L6.66663 27.4132C6.66663 20.8847 9.69926 15.4387 18.401 14.716Z"
                            fill="white"
                          />
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M45.1314 44.772C50.5996 49.1575 52.6511 48.8229 62.9197 48.1466L159.726 42.4088C161.779 42.4088 160.072 40.387 159.387 40.051L143.309 28.5782C140.229 26.2174 136.124 23.5137 128.259 24.1901L34.5211 30.9388C31.1024 31.2733 30.4196 32.9606 31.781 34.3129L45.1314 44.772ZM50.9435 67.0416V167.584C50.9435 172.988 53.679 175.009 59.8359 174.675L166.225 168.598C172.386 168.264 173.072 164.547 173.072 160.158V60.2898C173.072 55.9075 171.364 53.5442 167.594 53.8815L56.4149 60.2898C52.3117 60.6302 50.9435 62.6561 50.9435 67.0416ZM26.6506 21.8295L124.153 14.7419C136.126 13.7282 139.207 14.4073 146.732 19.8033L177.857 41.3965C182.992 45.1097 184.704 46.1206 184.704 50.1684V168.598C184.704 176.02 181.964 180.41 172.387 181.082L59.1583 187.831C51.9694 188.169 48.548 187.158 44.7832 182.431L21.8631 153.078C17.7565 147.674 16.0486 143.632 16.0486 138.903L16.0486 33.6342C16.0486 27.5646 18.7886 22.5015 26.6506 21.8295Z"
                            fill="black"
                          />
                        </svg>
                      </h1>
