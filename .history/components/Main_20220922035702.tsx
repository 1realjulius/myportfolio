  ...
  return (
    <div>
      <div className="flex flex-col gap-2 px-4 py-2 text-black dark:text-white md:grid md:grid-cols-3 md:gap-4 md:px-4">
        ...
        <div className=" row-span-2 flex flex-col items-center justify-center rounded-lg border-2 bg-white p-2  dark:border-[#24292f] dark:bg-[#0d1117] dark:text-white">
          <div className="relative h-[100px] w-[380px] items-center justify-center">
