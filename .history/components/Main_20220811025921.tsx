      ...
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
        ...
        >
          <div className="">
            ...
            <div className="m-2 border-2  divide-y-2 dark:divide-[#24292f]">
            <div className="border-2 border-green-200  bg-green-200 dark:bg-inherit  dark:border-[#24292f] rounded-lg">
