...
const Footer = () => {
  ...
  return (
    ...
    <div className='flex flex-row bg-white dark:text-white dark:bg-[#0d1117] border-2 dark:border-[#24292f] rounded-lg py-2 mb-4 px-4 mx-4 items-center justify-center'>
        <p className='flex text-xs'>Get Awesome Tips and Tricks with <span className='text-gray-400'>Ideatrends.</span> Coming Soon,</p>
         <p
          onClick={openModal}
          className="flex px-1 text-xs items-center space-x-2 hover:underline text-blue-600 cursor-pointer"
         >
