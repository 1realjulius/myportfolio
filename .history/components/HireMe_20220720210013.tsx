...
const HireMe = () => {
  return (
    <div className='p-4 pt-6 font-cadizMedium'>
        <div>
            <div className='px-2 pb-2'>
                <p className='text-base font-cadizMedium dark:text-white'>Hire Me Now!👌</p>
                <p className='text-sm font-cadizMedium text-gray-400'>I am familiar with systems like Git, Expo, Web 3 development, and Project Managemen</p>
            </div>
