...
const Banner = () => {
  return (
    <div className=' sticky top-0 z-50 flex flex-col items-center justify-center drop-shadow-md md:rounded-lg dark:bg-[#0d1117] bg-white mb-4 md:mt-2 p-2 md:border-2 dark:border-[#24292f]'>
