        ...
        <div className=" flex p-2 row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f]  flex-col border-2 rounded-lg">
          ...
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
              ...
              <div className="flex flex-row items-center space-x-2 group-hover:animate-wobble bg-blue-200 dark:bg-gray-900 px-3 py-1 rounded-md text-sm cursor-pointer">
                <p>View Website</p>
                <span>
                  <svg
