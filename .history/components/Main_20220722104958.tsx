          ...
          <div className='flex space-x-2'>
            <div className='flex  items-center'>
              <div className='flex flex-row bg-white items-center py-1 px-2 rounded space-x-2'>
                ...
                <h1 className='text-[12px] text-black'>Notion Official</h1>
              </div>
            </div>
            <div className='flex  items-center'>
              <div className='flex flex-row bg-blue-200 items-center py-1 px-2 rounded space-x-2'>
                <Image src="/Assets/notion-logo-1.svg" width="12" height='12' alt="" className='' />
                <h1 className='text-[12px] text-blue-800'>Free and Premium Checklists</h1>
              </div>
            </div>
          </div>
          ...
          <div className='flex space-x-2 items-center divide-x'>
            <div className='flex  items-center'>
              <div className='flex flex-row bg-white items-center py-1 px-2 rounded space-x-2'>
                ...
                <h1 className='text-[14px] text-black'>Notioncheck Checklists</h1>
              </div>
            </div>
            <Link href="/Notioncheck">
               <div className='flex py-1 px-3 items-center  cursor-pointer'>
                    <p className='text-gray-400 text-sm md:leading-none'>View Project </p>
                   <div className=''>
