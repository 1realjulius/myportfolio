...
const Banner = () => {
  ...
  return (
    <div className=' sticky top-2 z-20 flex flex-col items-center justify-center  rounded-lg dark:bg-[#0d1117] bg-white mb-4 mt-2 mx-1 p-2 border-2 dark:border-[#24292f]'>
      <div className=''>
      <Transition appear show={isOpen} as={Fragment}>
        ...
        <p className='text-sm dark:text-white text-black'>I am Seeking a Job as Front-End Web Developer. <span onClick={openModal} className='text-green-500 hover:underline cursor-pointer animate-pulse'>Hire Me</span></p>
    </div>
  )
}
