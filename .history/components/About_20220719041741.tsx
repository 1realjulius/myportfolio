      ...
      <div className=' text-black dark:text-white flex flex-col px-4  md:flex-row  md:px-4 items-center justify-center'>
        <div className='bg-white dark:bg-[#0d1117] col-span-2 my-1 p-4 rounded-lg border-2 dark:border-[#24292f]'>
          ...
          <div className='flex flex-col'>
            ...
            >
              Julius Eghan</span>  a Freelance Website and Software Developer from Accra, Ghana 🇬🇭.I specialize in React sJs, React Native and Product Design. I love building Startups and listening to <Link href="#"><span className='flex'><button className='text-green-400'>music.</button><Music className='text-black dark:text-white' size={16} /></span></Link></p>
          </div>
        </div>
        {/* this is the links */}
