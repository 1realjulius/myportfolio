  ...
  return (
    <div>
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
        ...
        <div className="bg-white dark:bg-[#0d1117] col-span-3 row-span-2 my-1 p-4 rounded-lg border-2 dark:border-[#24292f]">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-5 pt-2">
              <div>
                <button
                  className="text-gray-500 flex space-x-1 items-center hover:text-white"
                  onClick={() => (
        ...
        {/* project 4 section */}
        <div className=" col-span-2 row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg ">
          <div className="flex">
          ...
          <div className="flex flex-col  md:grid md:grid-cols-4 mx-4 mb-4 border-2 dark:border-[#24292f] md:divide-x-2 divide-y-2 md:divide-y-0 dark:divide-[#24292f] rounded-md ">
            ...
            <span>
              ...
              <h2>
                Provide Affordable and customized digital Solutions to my
                clients.
              </h2>
            </div>
            <div className="py-2 px-4">
              <span>
              <svg class="h-10 w-10 shrink-0 rounded-lg shadow-md shadow-sky-500/[.12] transform-cpu" viewBox="0 0 40 40" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M.75 8A7.25 7.25 0 018 .75h24A7.25 7.25 0 0139.25 8v24A7.25 7.25 0 0132 39.25H8A7.25 7.25 0 01.75 32V8z" class="fill-sky-50 stroke-sky-500"></path><path opacity="0.4" d="M17.25 33.25h-8.5a2 2 0 01-2-2V8.75a2 2 0 012-2h22.5a2 2 0 012 2v1m-4 3h-18.5" class="stroke-sky-500/40"></path><path d="M31.25 12.75h-8.5a2 2 0 00-2 2v16.5a2 2 0 002 2h8.5a2 2 0 002-2v-16.5a2 2 0 00-2-2z" class="fill-white stroke-sky-500"></path><path d="M26.75 30.25h.5" class="stroke-sky-500"></path></svg>
              </span>
        ...
        <div className=" dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] border-2 rounded-lg items-center justify-center p-4">
          ...
          <div className=" flex flex-col border-2 dark:border-[#24292f] divide-y-2 dark:divide-[#24292f] rounded-md">
            ...
            <div>
              <div className="flex bg-gray-400/80 items-center justify-center rounded-md m-2 px-4 py-2 cursor-pointer animate-pulse">
        ...
        >
          <div className="">
            ...
            <div className="m-2 border-2 dark:border-[#24292f]  divide-y-2 dark:divide-[#24292f] rounded-lg">
              {/* spotify */}
              <div className="  bg-green-200 dark:bg-inherit dark:border-2 dark:border-[#24292f] m-1 rounded-md ">
