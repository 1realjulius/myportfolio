      ...
      <form className="flex flex-col">
        ...
        <div className="mt-4">
          <button
            ...
            onClick={subscribe}
            name="subscribe"
            className="items-center inline-flex justify-center active:bg-blue-500 rounded-md border border-transparent bg-blue-100 px-4 py-2 text-sm font-medium text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 w-full"
