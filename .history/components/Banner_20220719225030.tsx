...
const Banner = () => {
  return (
    <div className=' sticky top-0 z-50 flex flex-col items-center justify-center  rounded-lg bg-transparent dark:bg-[#0d1117] bg-white mb-4 mt-2 mx-1 p-2 border-2 dark:border-[#24292f]'>
