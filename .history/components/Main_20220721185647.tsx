      ...
      <div className='text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2'>
        ...
        <div id='Projects' className='row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg p-4'>
          <div className='flex  items-center'>
            <div className='flex flex-row bg-blue-400 items-center py-1 px-2 rounded space-x-2'>
              <Image src="/Assets/notion-logo-1.svg" width="12" height='12' alt="" className='' />
              <h1 className='text-[12px]'>Notion Official Template</h1>
            </div>
          </div>
          <div className="flex">
            <Image src="/Assets/Notioncheck-logo-01.svg" width="85" height='85' alt="" className=' ' />
            <div>
              <h1 className='text-base'>Notioncheck</h1>
              <p className='text-sm'>Simplify your workflows with my Functional, and beginner-friendly notion templates and checklists.</p>
            </div>
          </div>
          <div>Project 1</div>
        </div>
