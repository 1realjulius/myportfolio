        ...
        >
          <div className="">
            ...
            <div className=" flex flex-col divide-y-2 rounded-lg border-2 dark:divide-[#24292f] dark:border-[#24292f]">
              <h1 className="text-xl flex space-x-2">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <Link href="tel:+233549321512">
                <span className="cursor-pointer text-lg text-blue-400 hover:underline">
                  +233 549 321 512
                </span>
              </Link>
              <h1 className="text-xl flex space-x-2 py-1 px-2">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <Link href="mailto:iamjuliusbusiness@gmail.com?subject=Let's work together 💰">
                <span className="cursor-pointer text-lg py-1 px-2 text-blue-400 hover:underline">
