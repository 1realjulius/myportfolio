      ...
      <div className='text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2'>
        ...
        <div className='row-span-2 bg-white dark:bg-[#0d1117] flex flex-col p-4 border-2 dark:border-[#24292f] rounded-lg gap-2'>
          ...
          <div className='flex flex-col items-start pt-2 p-2 border-2 dark:border-[#24292f] rounded-lg'>
            ...
            <h2 className='text-sm'><span className='font-cadizMedium'>Productivity Checklists</span> I create checklists for your workflow to make it simplified and faster.</h2>
          </div>
          <div className='flex flex-col items-start pt-2 p-2 border-2 dark:border-[#24292f] rounded-lg'>
          ...
          <div className='flex flex-col items-start pt-2 p-2 border-2 dark:border-[#24292f] rounded-lg'>
            <Image className='' src="/Assets/newmemoji.svg" width={30} height={30} alt="" />
            <h2 className='text-sm'><span className='font-cadizMedium'>Next Js Websites</span> I write clean and functional codes for websites like E-comerce, Portfolio sites, Agency Sites, Saas Sites.</h2>
          </div>
          <div className='flex flex-col items-start pt-2 p-2 border-2 dark:border-[#24292f] rounded-lg'>
            <Image className='' src="/Assets/newmemoji.svg" width={30} height={30} alt="" />
            <h2 className='text-sm'><span className='font-cadizMedium'>React Native Applications</span> I code functioanl mobile and desktop apps with one of the best cross-platform frameworks.I can make you a functioal ios, android, windows app, mac app, watch os app and web apps.</h2>
          </div>
        </div>
        {/* about me */}
