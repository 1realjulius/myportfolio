  ...
  return (
    <div>
      <div className="text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2">
            ...
            <div className="flex space-x-5 pt-2">
              ...
              <Link href="#PricesAndPackages">
                <p className="text-sm flex space-x-2 items-center cursor-pointer">
                  <span className="text-gray-500 "> Check Out My Prices and Packages</span>
                  <Package
        ...
        {/* project 4 section */}
        <div className=" col-span-2 row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg items-center">
          <div className="flex flex-col  md:grid md:grid-cols-4 m-4 border-2 dark:bg-[#0d1117] md:divide-x-2 divide-y-2 rounded-md ">
            <div className="p-2"><h2>I Provide Affordable and customized digital Solutions to my clients</h2></div>
            <div className="p-2"><h2>Building engaging user experience</h2></div>
            <div className="p-2"><h2>Providing Satisfactory Customer Services</h2></div>
            <div className="p-2"><h2>Maximizing Client&apos;s operations effectively</h2></div>
          </div>
        </div>
        {/* what i do section */}
