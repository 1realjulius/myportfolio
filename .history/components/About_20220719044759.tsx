...
import { Facebook, Heart, Instagram, Linkedin, Music, Twitter } from 'react-feather'
          ...
          <div className='flex flex-col'>
            ...
            <Link href="https://open.spotify.com/user/l9obknmym5mbo8h0mp86ilvnv?si=5c8cb40d57be471d">
                <button className='text-green-400 flex space-x-1 items-center'>
                  <p className='flex items-center space-x-2'><span>I </span><Heart className='text-red-400 ' size={10} /><span> music</span></p>
