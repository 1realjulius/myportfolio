        ...
        >
          <div className="">
            ...
            <div className="divide-y-2 rounded-lg  border-2 dark:divide-[#24292f] dark:border-[#24292f]">
                  ...
                  <Link href="https://notioncheck.gumroad.com/">
                    ...
                    >
                      ...
                      <h1 className="flex flex-row items-center space-x-2">
                        <span className="text-lg text-black font-ApercuBold">Notioncheck</span>
                        <svg
                          className="w-6 h-6"
                          viewBox="0 0 200 200"
                          fill="none"
              ...
              {/* My Store */}
              <div>
                <div className="  m-1 rounded-md bg-blue-400 ">
                  <Link href="https://www.buymeacoffee.com/iamjulius">
                    <div
                      id="BuyMeACoffe"
                      className="flex cursor-pointer justify-between  p-2"
                    >
                      <h1 className="text-black text-lg">My E-commerce Store</h1>
                      <span></span>
                    </div>
                  </Link>
                </div>
