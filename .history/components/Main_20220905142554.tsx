          ...
          <div className="p-2">
            <div className="flex flex-row items-center justify-between">
              <div className="flex flex-row items-center space-x-2 ">
                ...
                <h1 className="text-lg">Photocos Agency</h1>
              </div>
              <Link href="https://1realjulius.github.io/Photocos_Agency/">
                <div className="flex cursor-pointer flex-row items-center space-x-2  rounded-full bg-blue-200 px-3 py-1 text-sm dark:bg-gray-900">
                  {/* <p>View Website</p> */}
                  <span>
                    <svg
                      className="h-6 w-6 hover:animate-wobble"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
