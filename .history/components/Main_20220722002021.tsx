        ...
        <div id='Projects' className='row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg p-4'>
          ...
          <div className='flex space-x-2'>
            <Link href="/Notioncheck">
               <div className='flex border py-1 px-3 rounded-lg w-full cursor-pointer'>
                   <div className='flex flex-row items-center justify-center'>
                     <p className='text-gray-400'>View Project (Notioncheck)</p>
            ...
            <Link href="https://notioncheck.gumroad.com/">
               <div className='flex cursor-pointer'>
                   <div className='flex flex-row items-center space-x-2 hover:underline'>
                     <p className='text-gray-400 text-sm'>notioncheck.gumroad.com</p>
