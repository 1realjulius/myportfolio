  ...
  return (
    <div>
      <div className="flex flex-col gap-2 px-4 py-2 text-black dark:text-white md:grid md:grid-cols-3 md:gap-4 md:px-4">
        ...
        {/* project 3 section */}
        <div className=" row-span-2 flex cursor-not-allowed flex-col rounded-lg border-2 bg-white   opacity-50 dark:border-[#24292f] dark:bg-[#0d1117]  dark:text-white">
          <div>
            {/* Img width= 400 and height= 200 */}
            <Image
        ...
        <div className=" col-span-2 row-span-2 flex flex-col rounded-lg border-2 bg-white text-sm dark:border-[#24292f] dark:bg-[#0d1117] dark:text-white">
          ...
          <div className="mx-2 mb-4  flex flex-col divide-y-2 rounded-md border-2 dark:divide-[#24292f] dark:border-[#24292f] md:grid md:grid-cols-4 md:divide-x-2 md:divide-y-0 ">
