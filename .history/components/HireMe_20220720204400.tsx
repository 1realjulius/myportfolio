    ...
    <div className='p-4 font-cadizMedium'>
        <div>
            <div className='px-2 pb-2'>
                <p className='text-base font-cadizMedium dark:text-white'>Hire Me <span className='text-xs bg-blue-400 text-white py-1 px-2 rounded-lg'>Front-End Web Developer</span> </p>
