...
export const ProjectHead = () => {
  return (
    <div className='flex flex-col mx-4  items-center justify-center space-x-2 border-2 p-2'>
        <div className=' border-2 rounded-lg'>
          <Image src="/Assets/notioncheck-dark-lg.png" width="600%" height='400%' alt="" className='rounded-lg' />
        </div>
        <div className=''>
