  ...
  return (
    <div>
      <div className='text-black dark:text-white flex flex-col md:grid md:grid-cols-3 md:gap-4 gap-2 px-4 md:px-4 py-2'>
        {/* project 1 section */}
        <div id='Projects' className='relative row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg  items-center justify-center'>
          <div className="absolute bg-local">
            <Image src="/Assets/img-project-1.png" width="100%" height='100%' alt="" className='absolute object-cover' />
          </div>
          <div>Project 1</div>
        </div>
        {/* project 2 section */}
