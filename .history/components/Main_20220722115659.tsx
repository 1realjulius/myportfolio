        ...
        <div id='Projects' className='row-span-2 dark:bg-[#0d1117] dark:text-white bg-white dark:border-[#24292f] flex flex-col border-2 rounded-lg p-4'>
          <div className='flex space-x-2'>
            <div className='flex  items-center'>
              <div className='flex flex-row border-2 border-blue-400  items-center py-1 px-2 rounded-xl space-x-2'>
                <h1 className='text-[12px] leading-none text-blue-400'>New</h1>
              </div>
            </div>
            <div className='flex  items-center'>
