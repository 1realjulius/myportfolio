      ...
      <div className=' text-black dark:text-white flex flex-col px-4  md:flex-row  md:px-4 items-center justify-center'>
        <div className='bg-white dark:bg-[#0d1117] col-span-2 my-1 p-4 rounded-lg border-2 dark:border-[#24292f]'>
          ...
          <div className='flex flex-col'>
            ...
            >
              Julius Eghan</span>  a Freelance Website and Software Developer from Accra, Ghana 🇬🇭.I make websites and mobile apps with React Js, React Native and Product Design. I love building Startups and 
              <Link href="https://open.spotify.com/user/l9obknmym5mbo8h0mp86ilvnv?si=5c8cb40d57be471d"><span className='items-center space-x-1'><button className='text-green-400 items-center'>listening to music<Music className='text-green-400' size={14} /></button></span></Link></p>
          </div>
        </div>
        {/* this is the links */}
