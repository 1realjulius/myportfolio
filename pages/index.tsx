  ...
  return (
    <div className="flex min-h-screen flex-col pt-4 bg-[#f7f2f2] dark:bg-[#090c10] font-ApercuMedium md:p-8">
      <Head>
        ...
        <meta name="description" content="Developer and Digital Designer from Ghana." />
        <meta property="og:type" content="website"/>
        <meta property="og:url" content="https://iamjulius.vercel.app/"/>
        <meta property="og:title" content="Julius Eghan — Developer, Digital Designer"/>
        <meta property="og:description" content="Developer and Degital Designer from Ghana. "/>
        ...
        <meta property="twitter:description" content="Developer and Degital Designer from Ghana."/>
